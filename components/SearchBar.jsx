...
function setButtonActivity(selectPassportHook, selectDestinationHook){
    if(selectPassportHook === '' || selectDestinationHook === '')
        return(<button type="submit" className={"border-transparent cursor-pointer md:w-[15rem] lg:w-[75%] xl:w-[71.5%] 2xl:w-[72.5%] h-14 w-60 mb-0.5 mt-1 md:ml-2 lg:ml-8 2xl:ml-10 max-md:ml-6 pt-[1.15rem] 2xl:pt-3.5 float-right bg-stone-300 rounded-xl flex justify-center font-semibold text-sm 2xl:text-base leading-tight px-4 text-center text-stone-600"}> Do you need a visa?</button>);
    else
        return(<button type="submit" className={"border-transparent cursor-pointer md:w-[15rem] lg:w-[75%] xl:w-[71.5%] 2xl:w-[72.5%] h-14 w-60 mb-0.5 mt-1 md:ml-2 lg:ml-8 2xl:ml-10 max-md:ml-6 pt-[1.15rem] 2xl:pt-3.5 float-right bg-stone-300 rounded-xl flex justify-center font-semibold text-sm 2xl:text-base leading-tight px-4 text-center text-stone-600 hover:bg-stone-400 hover:text-stone-700"}> Do you need a visa?</button>);
}
...
const SearchBar = () => {
    ...
    return(        
        <form type="submit" onSubmit={handleFormSubmit}>
            <div className={"rounded-2xl bg-stone-700 mb-10 md:mb-4 md:mb-8 md:pb-3 pb-5 md:pt-2 pt-3.5 pl-0.5 md:pl-4 lg:pl-4 2xl:pl-6 md:gap-x-0 xl:gap-x-10 2xl:gap-x-28 grid sm:grid-rows-3 md:grid-rows-2 lg:grid-rows-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-4 md:gap-y-3 lg:gap-y-4 w-72 md:w-[34.5rem] lg:w-[75.5%] xl:w-[58.6%] sm:content-center"}>
                <div className={"bg-stone-300 rounded-l-lg mt-1 w-[20%] md:w-[27.25%] lg:w-4/12 md:rounded-r-2xl-0 h-[3.25rem] md:h-14 ml-6 md:mx-2 lg:ml-2"}>
                    <div className={"relative inline-block gap-x-3 just ify-start content-center w-60 md:w-[15rem] lg:w-[13.35rem] 2xl:w-80 -mb-0.5 md:mb-0"}>
                        <Image src="passport.svg" width={32} height={32} className={"select-none absolute mt-2.5 ml-3 2xl:ml-6"}></Image>
                ...
                <div className={"bg-stone-300 rounded-l-lg mt-1 w-[23%] md:w-[27.25%] lg:w-4/12 xl:w-4/12 h-[3.25rem] md:h-14 ml-6 md:mx-6 md:ml-2 lg:ml-2"}>
                    <div className={"relative inline-block justify-start content-center w-60 lg:w-[15rem] 2xl:w-80"}>      
                        <Image src="pin.svg" width={29.5} height={29.5} className={"select-none absolute mt-3 ml-4 2xl:ml-6"}></Image>   
