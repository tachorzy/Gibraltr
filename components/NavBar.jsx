    ...
    return(
        <div className={albula.className + " absolute top-0 align-baseline h-20 w-screen space-x-12 md:space-x-96 flex flex-row z-50"}>
            <div className={"flex flex-row relative "}>
                ...
                <h1 className={`${lightingMode == "light" ? "text-stone-700" : "text-stone-300"} font-thin absoltue pt-6 md:mb-0 md:pt-7 2xl:pt-8 ml-[97%] md:ml-32 2xl:ml-36 text-3xl md:text-4xl 2xl:text-5xl`}>Gibraltr</h1>
            </div>
