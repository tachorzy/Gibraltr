        ...
        <div className={albula.className + " absolute top-0 align-baseline h-20 w-screen space-x-12 md:space-x-96 flex flex-row z-50"}>
            <div className={"flex flex-row relative "}>
                <Link href="/">
                    ...
                    <Image src={lightingMode == "light" ? "/gibraltar-stone-800.svg" : "/gibraltar-stone-300.svg"} width={90} height={90} className={"select-none ml-6 fixed cursor-pointer hidden md:block"} alt="Gibraltr logo"></Image>
                </Link>
