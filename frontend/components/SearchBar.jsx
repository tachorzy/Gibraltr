...
const SearchBar = () => {
    ...
    return(        
        <form type="submit" onSubmit={handleFormSubmit}>
            <div className={"rounded-2xl bg-stone-700 mb-10 md:mb-4 md:mb-8 md:pb-3 pb-5 md:pt-2 pt-3.5 2xl:py-4 pl-0.5 md:pl-4 lg:pl-4 md:gap-x-0 xl:gap-x-8 2xl:gap-x-4 grid sm:grid-rows-3 md:grid-rows-2 lg:grid-rows-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-4 md:gap-y-3 lg:gap-y-4 w-72 md:w-[34.5rem] lg:w-[75.5%] xl:w-[59.5%] 2xl:w-[68%] sm:content-center"}>
